...
>
  ...
  <p>
To learn more about what properties you can change through a<code>Theme</code>, check the <a href='/docs/docs-themes-theme-definition--page'>👉 Theme definition page</a>
  </p>
</div>
</PolarisVizProvider>
